...
import { ItemI } from './items.interface'
...
interface IAddItemModal {
    ...
    initialData?: ItemI
    setItemToModify: (item: ItemI) => void
}

export const AddItemModal = ({ open, setOpen, initialData, setItemToModify }: IAddItemModal) => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            // Convertir las propiedades a números
            const formattedData = {
                ...formData,
